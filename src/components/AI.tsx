          ...
          <div className=" lg:w-2/3 w-full">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              <ol style={{ listStyleType: "disc" }} className="ml-4">
                <li>
                  ถ้าผลการพยากรฌ์เป็น lung_acs หมายความว่าเป็นโรคมะเร็งปอดชนิด
                  asc
                </li>
                <li>
                  ถ้าผลการพยากรฌ์เป็น lung_n หมายความว่าเป็นปกติไม่โรคมะเร็งปอด
                </li>
                <li>
                  ถ้าผลการพยากรฌ์เป็น lung_scc หมายความว่าเป็นโรคมะเร็งปอดชนิด
                  scc
                </li>
              </ol>
            </p>
